...
See [CONTEXT.md](CONTEXT.md) for the project's terms, [ROADMAP.md](ROADMAP.md) for the longer plan, and [ADR-0001](docs/adr/0001-no-llm-in-the-dictation-path.md) for the cleanup decision. For a full walkthrough of the architecture, the trade-offs behind it, and where the project actually stands against the roadmap, see [docs/progress/](docs/progress/) - a dated checkpoint per phase, most recent first: [phase-3-progress.md](docs/progress/phase-3-progress.md), [phase-2-progress.md](docs/progress/phase-2-progress.md), [phase-1-progress.md](docs/progress/phase-1-progress.md).
