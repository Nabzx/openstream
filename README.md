...
You need Apple Silicon, macOS 13 or newer, Node 22.12+, Xcode Command Line Tools and CMake. `npm install` also builds whisper.cpp and two Swift helpers and fetches about 1.6 GB of models, so it takes a while.
...
- `whisper.cpp` (`large-v3-turbo`) transcribes on the GPU, resident for the app's life.
