...
export type Page = "home" | "files" | "commands" | "settings" | "permissions" | "setup";

export const PAGES = ["home", "files", "commands", "settings", "permissions", "setup"] as const;

export const TAB_PAGES = ["home", "files", "commands", "settings"] as const;
