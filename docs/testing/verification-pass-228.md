...
| **Latency** | Warm dictations: 150–260 ms release-to-cursor, every time — well inside the sub-1s budget. Parakeet transcription alone is ~150–300 ms on a short clip. |
