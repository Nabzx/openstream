...
- [ ] Decide and build the injection mechanism, its guard against a stale target, and what the user sees when it fails ([#62](https://github.com/Nabzx/openstream/issues/62)) - getting the text into the field the user is pointing at is the load-bearing problem
