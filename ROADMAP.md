...
- **Parakeet TDT 0.6b v3 as the transcription model server** — replaced `whisper base.en` ([#317](https://github.com/Nabzx/openstream/pull/317), [ADR-0003](docs/adr/0003-parakeet-for-transcription.md)). Runs as CoreML on the Neural Engine via FluidAudio. Pipeline shape unchanged ([ADR-0002](docs/adr/0002-no-one-model-dictation-engine.md)). Remaining accuracy follow-ups: [#320](https://github.com/Nabzx/openstream/issues/320) (done), [#321](https://github.com/Nabzx/openstream/issues/321) (done), [#322](https://github.com/Nabzx/openstream/issues/322).

### v1.1 — parity + the quick wins their users are begging for

- **Codebase vocabulary biasing** ([#250](https://github.com/Nabzx/openstream/issues/250)) — un-shelve [#16](https://github.com/Nabzx/openstream/issues/16). Note: Parakeet has no `initial_prompt`; the boosting route is [#322](https://github.com/Nabzx/openstream/issues/322) (FluidAudio keyword spotter) plus [#321](https://github.com/Nabzx/openstream/issues/321) (a post-hoc correction table, done).
- **Remove the dormant whisper.cpp path** ([#326](https://github.com/Nabzx/openstream/issues/326)) (done) — kept as a revert path while Parakeet proved out; removed once [#228](https://github.com/Nabzx/openstream/issues/228) confirmed it.
...
- **In-app model picker + download** ([#251](https://github.com/Nabzx/openstream/issues/251)) (done), **multiple languages + auto-detect** ([#252](https://github.com/Nabzx/openstream/issues/252)) (done), **drag-and-drop file transcription** ([#253](https://github.com/Nabzx/openstream/issues/253)) (PR open, pending a manual pass on the native Swift piece).
- **Polish parity** — surface model-server failures to the user ([#254](https://github.com/Nabzx/openstream/issues/254)) (done), copy-to-clipboard option ([#255](https://github.com/Nabzx/openstream/issues/255)) (done), completion chime + indicator position ([#256](https://github.com/Nabzx/openstream/issues/256)) (done), idle model unload ([#257](https://github.com/Nabzx/openstream/issues/257)) (done), mouse-button trigger ([#258](https://github.com/Nabzx/openstream/issues/258)), recording history ([#136](https://github.com/Nabzx/openstream/issues/136)) (done) with retention controls ([#264](https://github.com/Nabzx/openstream/issues/264)) (done), and a microphone device selector ([#137](https://github.com/Nabzx/openstream/issues/137)) (PR open, pending a manual pass - no second mic in the build environment to test against).

### v1.2 — the overtake features (neither app has them)

- **Post-processing hooks after cleanup** ([#259](https://github.com/Nabzx/openstream/issues/259)) (done) — their [#55]. A shell script, not a second LLM path - see [ADR-0004](docs/adr/0004-shell-script-post-processing-hook.md). Semantic voice edits ([#222](https://github.com/Nabzx/openstream/issues/222)) can live here as a script once a capable local model exists, rather than a hook type of their own.
